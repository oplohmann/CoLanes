...
import org.objectscape.colanes.util.atomic.map.PutEvent;
import org.objectscape.colanes.util.atomic.map.RemoveEvent;
 ...
 *
 */
public class CarSTM implements CoReceiver {
    ...
    {
        ListenableAtomicMap<TrafficLightSTM.Color, Boolean> lights = Registry.getDefault().getListenableAtomicMapNamed(TrafficLightSTM.TagName);
