 ...
 *
 */
public class AbstractMemoizingCalculator implements CoReceiver, AtomicUtils
{
    protected static final String FactorialCacheName = "FactorialCache";

    protected CoLane lane = new CoLane();

    protected long factorial(int n)
    {
        // go with a non-recursive solution to prevent stackoverflow

        long factorial = n;
        long factor = factorial;
