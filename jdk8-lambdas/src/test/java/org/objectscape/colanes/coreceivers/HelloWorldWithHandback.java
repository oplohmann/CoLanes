 ...
 *
 */
public class HelloWorldWithHandback implements CoReceiver {
    ...
    public Handback sayHello() {
        return lane.getHandback().runnable(() -> sayHelloInternal());
    }

    public Handback sayHelloNoHandbackOverwrite() {
        return lane.getHandback(false).runnable(() -> sayHelloInternal());
    }
